...
public class OrganisationServiceTest {
	...
	@MockBean private OrgRepository orgRepo;
 ...
 public void createOrg_withNewOrganisation_shouldReturnOrganisation() throws CustomExceptions {
	...
	public void getByEmail_when_NoEmailPresent_shouldThrowResoureNotFoundException() throws ResourceNotFoundException {
		...
		ResourceNotFoundException exp = assertThrows(ResourceNotFoundException.class, ()->orgService.getByEmail("org@org.com"));
		 verify(orgRepo, times(1)).findByOrganisationEmail(org.getOrganisationEmail());
	...
	@Test
	public void deleteByEmail_when_NoEmailPresent_shouldThrowResoureNotFoundException() throws ResourceNotFoundException {
		
		when(orgRepo.findByOrganisationEmail("org@org.com")).thenReturn(Optional.ofNullable(null));
		
		ResourceNotFoundException exp = assertThrows(ResourceNotFoundException.class, ()->orgService.deleteByEmail("org@org.com"));
		 verify(orgRepo, times(1)).findByOrganisationEmail(org.getOrganisationEmail());
		assertEquals("Orgaisation not found with email : org@org.com",exp.getMessage());
	}
	...
	public void findByAgencyEmail_when_AgencyPresent_should_returnOrganisations() throws  CustomExceptions {
		...
		when(orgRepo.findByInsuranceAgencyEmail(AGENCY_Email)).thenReturn(
				Stream.of(
						new Organisation(AGENCY_Email, "org1", "org1@org.com", "pass1"),
				         new Organisation(AGENCY_Email, "org2", "org2@org.com", "pass2"),
				         new Organisation(AGENCY_Email, "org3", "org3@org.com", "pass3"),
				         new Organisation(AGENCY_Email, "org4", "org4@org.com", "pass4")).collect(Collectors.toList()));
	...
	//throw Excep  
		...
		public void findByAgencyEmail_when_Agency_Not_Present_should_thorwoCustomExp() throws  CustomExceptions {
			...
			CustomExceptions ex = assertThrows(CustomExceptions.class, ()->orgService.getByAgencyEmail(AGENCY_Email));
	...
	@Test
	public void deleteAllByEmail_when_EmailPresent_should_deleteOrganisation() throws ResourceNotFoundException, CustomExceptions {
	...
	public void deleteAllByEmail_when_Email_NOT_Present_should_throwCustomExp() throws  CustomExceptions {
		...
		CustomExceptions ex = assertThrows(CustomExceptions.class, ()->orgService.deleteByAgencyEmail(AGENCY_Email));
